...
public class ReportReceipt {
    private static final Logger LOGGER = Logger.getLogger(ReportReceipt.class.getName());
    ...
    public ReportReceipt(CrimeReport crimeReport) {
        this.crimeReport = crimeReport;
        createPdf("src/main/resources/files/pdf/" + crimeReport.getRef() + ".pdf");
    }

    public ReportReceipt(CrimeReport crimeReport, String filePath) {
        this.crimeReport = crimeReport;
        createPdf(filePath);
    }
