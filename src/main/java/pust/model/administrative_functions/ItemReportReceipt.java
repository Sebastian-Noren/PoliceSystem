...
public class ItemReportReceipt {
    ...
    private void informerInformation(PdfDocument pdf, Document document) {
        ...
        Cell c12 = new Cell();
        c12.add(missingItemReport.getNotifier().getFirstName());
        ...
        Cell c22 = new Cell();
        c22.add(missingItemReport.getNotifier().getSurname());
        ...
        Cell c32 = new Cell();
        c32.add(missingItemReport.getNotifier().getPersonalNumber().getPersonalNumber());
        ...
        Cell c42 = new Cell();
        c42.add(missingItemReport.getNotifier().getAddress().getStreet());
        ...
        Cell c52 = new Cell();
        c52.add(String.valueOf(missingItemReport.getNotifier().getAddress().getZipCode()));
        ...
        Cell c62 = new Cell();
        c62.add(missingItemReport.getNotifier().getAddress().getCity());
        ...
        Cell c72 = new Cell();
        c72.add(missingItemReport.getNotifier().getPhoneNumber());
    ...
    private Paragraph addLine() {
        return new Paragraph("______________________________________________________________________________");
    }
